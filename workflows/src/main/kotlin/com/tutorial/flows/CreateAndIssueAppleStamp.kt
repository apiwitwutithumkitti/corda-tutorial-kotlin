...
@StartableByRPC // This annotation allows the flow to started by RPC.
class CreateAndIssueAppleStampInitiator(
    private val stampDescription: String,
    ...
    override fun call(): SignedTransaction {
        ...
        */
        ...
        val fullySignedTx = subFlow(
            CollectSignaturesFlow(partSignedTx, listOf(otherPartySession)))
